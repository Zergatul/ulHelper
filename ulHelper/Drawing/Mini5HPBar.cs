...
{
    public class Mini5HPBar : SimpleBar
    {
        static Bitmap leftBmp, rightBmp, centerBmp, leftBgBmp, rightBgBmp, centerBgBmp;

        public static void Load()
        {
            leftBmp = new Bitmap(@"Images\HP_mini5_left.png");
            centerBmp = new Bitmap(@"Images\HP_mini5_center.png");
            rightBmp = new Bitmap(@"Images\HP_mini5_right.png");

            leftBgBmp = new Bitmap(@"Images\HP_mini5_bg_left.png");
            centerBgBmp = new Bitmap(@"Images\HP_mini5_bg_center.png");
            rightBgBmp = new Bitmap(@"Images\HP_mini5_bg_right.png");
        }

        public Mini5HPBar(int width)
        {
            this._width = width;
            this._height = 5;
